...
public class UserChattingroomTutor implements java.io.Serializable {
	...
	public UserChattingroomTutor() {
		super();
	}

	public UserChattingroomTutor(int user_no, int chat_room_no, int student_no, int tutor_no, String student_name,
			String tutor_name, String user_ssn, String user_name, String user_phone, String user_id, String user_pwd,
			String user_email, String user_position, String login_ok, String pic, String min_pay, String online_ok,
			String area, String intro, String day, String time, String style, String l_grd, String class_min,
			String class_times, String sub_name) {
		super();
	...
	public String toString() {
		return "UserChattingroomTutor [user_no=" + user_no + ", chat_room_no=" + chat_room_no + ", student_no="
				...
				+ user_position + ", login_ok=" + login_ok + ", pic=" + pic + ", min_pay=" + min_pay + ", online_ok="
