...
public class Member implements java.io.Serializable{
	...
	public Member(int user_no, String user_ssn, String user_name, String user_phone, String user_id, String user_pwd,
	...
	public String toString() {
		return "Member [user_no=" + user_no + ", user_ssn=" + user_ssn + ", user_name=" + user_name + ", user_phone="
