...
public class NaverLoginBO {
	...
	private final static String CLIENT_ID = "O1DNpjOo6U7RT1EEQ0Cw";
	private final static String CLIENT_SECRET = "RIdLvHYvm1";
	private final static String REDIRECT_URI = "http://localhost:8087/itys/callback.do";
